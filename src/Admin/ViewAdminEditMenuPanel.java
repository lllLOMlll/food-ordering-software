...
public class ViewAdminEditMenuPanel extends JPanel {
	private JTable tableRestaurant;
	private JButton btnSelect;
	private JTable tableCreateMenu;
	private JButton btnSaveMenu;
	 ...
	 * Create the panel.
	 */
	public ViewAdminEditMenuPanel(Model model) {
		this.model = model;
		...
		btnSaveMenu = new JButton("Save");
		btnSaveMenu.setBounds(545, 427, 95, 23);
		add(btnSaveMenu);
		...
		btnDeleteItem.setBounds(662, 556, 101, 23);
		add(btnDeleteItem);
	}
	/**
	 * @return the btnSaveMenu
	 */
	public JButton getBtnSaveMenu() {
		return btnSaveMenu;
	}
	/**
	 * @param btnSaveMenu the btnSaveMenu to set
	 */
	public void setBtnSaveMenu(JButton btnSaveMenu) {
		this.btnSaveMenu = btnSaveMenu;
	}
	/**
