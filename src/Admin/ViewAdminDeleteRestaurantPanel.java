...
public class ViewAdminDeleteRestaurantPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ViewAdminDeleteRestaurantPanel(Model model) {
		this.model = model;
		...
		JLabel lbDeleteRestaurant = new JLabel("Delete Restaurant");
		lbDeleteRestaurant.setHorizontalAlignment(SwingConstants.CENTER);
		lbDeleteRestaurant.setFont(new Font("Tahoma", Font.BOLD, 18));
		lbDeleteRestaurant.setBounds(495, 11, 185, 26);
		add(lbDeleteRestaurant);
		...
		btnDelete.setBounds(70, 427, 163, 23);
		add(btnDelete);
