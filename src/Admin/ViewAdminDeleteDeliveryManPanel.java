...
public class ViewAdminDeleteDeliveryManPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ViewAdminDeleteDeliveryManPanel(Model model) {
		this.model = model;
		...
		btnSelectDeliveryMan.setBounds(55, 607, 251, 23);
		add(btnSelectDeliveryMan);
		
		JLabel lbDeleteDeliveryMan = new JLabel("Delete Delivery Man");
		lbDeleteDeliveryMan.setHorizontalAlignment(SwingConstants.CENTER);
		lbDeleteDeliveryMan.setFont(new Font("Tahoma", Font.BOLD, 18));
		lbDeleteDeliveryMan.setBounds(359, 11, 404, 26);
		add(lbDeleteDeliveryMan);
		...
		// Set the formatted text field's value
		 ...
		 JLabel lblNewLabel_8 = new JLabel("Delivery Area");
			...
			btnDelete.setBounds(495, 398, 126, 51);
			add(btnDelete);
	...
	public void setBtnDeleteDeliveryArea(JButton btnDeleteDeliveryArea) {
		this.btnDelete = btnDeleteDeliveryArea;
	}
	/**
