...
public class ViewManagerEditDeliveryManPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ViewManagerEditDeliveryManPanel(Model model) {
		this.model = model;
		...
		// Initialize the table first
					...
					tableDeliveryMan.setModel(deliveryManTableModel);

					// Update the table with the delivery men
					updateDeliveryManTable("Roger");
					updateDeliveryManTable("John");
					updateDeliveryManTable("Melanie");
					updateDeliveryManTable("Judith");
					updateDeliveryManTable("Suzan");
		...
		scrollPane.setBounds(55, 49, 251, 468);
		add(scrollPane);
		
		btnSelectDeliveryMan = new JButton("Select");
		btnSelectDeliveryMan.setBounds(55, 528, 251, 23);
